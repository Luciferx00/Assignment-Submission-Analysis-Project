...
//assign_flag=1 will be used for assignments otherwise everything will be same from posts
     $query="SELECT * FROM posts  WHERE id < ".$_SESSION['next_ref']." AND assign_flag=1 ORDER BY due_date DESC LIMIT 10 ";
...
while($post_data=mysqli_fetch_assoc($post_result))
 ...
 <p><b><?php echo "Due date is:".$post_data['due_date']?></b><br>
 <?php echo $post_data['post_content'] ?><br></p>
 <p><?php echo "<a href='./docs/{$post_data['file_name']}'>".$post_data['file_name'] ."</a>"?></p>
  <?php
  echo "</div></li>";
  ...
  ?>
    <div id="new_assignment">
     ...
     <form method="post" action=<?php echo $url; ?>>
        ...
        <span style="font-weight: bold;font-style: normal;text-decoration: none;">Due date</span> 
        <input type="text " size="15"  name="due_date">
